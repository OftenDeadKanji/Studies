...
{
    public partial class ManagerDriverShow : BaseForm
    {
        DataTable dataTable;
                ...
                if(assigments != "")
                {
                    ...
                    if (splitedAssigments.Length > 1)
                    {
                        ...
                        if(splitedLines.Length == splitedAssigments.Length)
                        {
                            ...
                            {
                                ChangeForm(this, new ManagerDriverLines(driverId, name, surname, assigmentIDs, lineNumbers));
                            }
                        }                        
                    }
                    else
                    {
                        ...
                        {
                            ChangeForm(this, new ManagerDriverAssigments(driverId, name, surname, assigment));
                        }
                    }
                }
            }
        ...
        public ManagerDriverShow(int driverId, string name, string surname)
        {
            InitializeComponent();
        ...
        {
            ChangeForm(this, new ManagerDrivers());
        }

        private void buttonAdd_Click(object sender, EventArgs e)
        {
            ChangeForm(this, new ManagerDriverAbsence(driverId, name, surname));
        }
        ...
        private void LoadData()
        {
            ...
            //dataTable.Columns.Add("Godzina", typeof(TimeSpan));
            ...
            TimeSpan.TryParse("00:00:00", out hour);
            TimeSpan.TryParse("01:00:00", out toAdd);
            TimeSpan.TryParse("23:00:00", out endHour);

            while(hour <= endHour)
            {
                dataGridView.Rows.Add(hour);
                hour += toAdd;
            }
            */
            int hour = 0;
