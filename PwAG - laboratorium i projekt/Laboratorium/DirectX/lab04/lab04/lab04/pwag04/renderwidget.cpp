...
RenderWidget::RenderWidget(float width, float height, HWND winId) :
	...
	m_CameraPosition(5.f, 0.f, -5.f), m_CameraTarget(0.f, 0.f, 0.f), m_CameraUp(0.f, 1.f, 0.f),
	m_CameraDataDirty(true), m_ObjPosDataDirty(true), m_UseGeometryShader(false), m_ForceConstBuffersUpdate(false)
{
...
void RenderWidget::dxRender()
{
	...
	m_pContext->ClearDepthStencilView(m_pDepthStencilView, D3D11_CLEAR_FLAG::D3D11_CLEAR_DEPTH, 1, 0);
