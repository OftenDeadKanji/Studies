...
void RenderWidget::dxCreateInputLayouts(ID3DBlob *vsBlob)
{
	...
	D3D11_INPUT_ELEMENT_DESC colElement = { "COLOR", 0,  DXGI_FORMAT_R32G32B32A32_FLOAT, 0, 12, D3D11_INPUT_PER_VERTEX_DATA, 0 };
...
void RenderWidget::dxCreateVertexBuffers()
{
	...
	vertices.push_back(VertexType(+0.5f, +0.5f, 0.5f, 1.0f, 0.0f, 0.0f));
...
void RenderWidget::dxConfigureVertexShaderStage(bool sceneConstantsOutdated, bool objectConstantsOutdated)
{
	...
	memcpy(mappedRes.pData, &m_ViewProjectionMatrix, sizeof(m_ViewProjectionMatrix));
	...
	worldMatrix._41 = m_ObjPosX + 0.3f; worldMatrix._42 = m_ObjPosY + 0.2f; worldMatrix._43 = m_ObjPosZ + 0.1f;
	...
	memcpy(mappedRes.pData, &worldMatrix, sizeof(worldMatrix));
