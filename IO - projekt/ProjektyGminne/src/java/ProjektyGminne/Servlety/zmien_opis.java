 ...
 * @author Frogi
 */
@WebServlet(name = "zmien_opis", urlPatterns = {"/zmien_opis"})
public class zmien_opis extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (zalogowany == 'u') {
            try (PrintWriter out = response.getWriter()) {
                ...
                String nowy_opis_projektu = request.getParameter("nowy_opis_projektu");

                if (nowy_opis_projektu.length() == 0) {
                    out.println("<h2 style=\"color: #BB1245;\">");
