 ...
 * @author Frogi
 */
@WebServlet(name = "Panel_uzytkownika_mieszkaniec", urlPatterns = {"/Panel_uzytkownika_mieszkaniec"})
public class Panel_uzytkownika_mieszkaniec extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<h1>Panel mieszkańca</h1>");
            out.println("Użytkownik: " + mieszkaniec.getLogin() + "<br>");
            out.println("adres e-mail: " + mieszkaniec.getAdresEmail() + "<br><br>");
            out.println("<form method=POST action=zmien_email>");
            out.println("<input name=\"nowy_email\" type=text placeholder=\"Nowy E-mail\"/><br>");
            out.println("<input name=\"haslo\" type=password placeholder=\"Hasło\"/><br><br>");
            out.println("<input type=submit value=\"Zmień e-mail\"/><br>");
            out.println("</form><br>");
            out.println("<form method=POST action=zmien_haslo_mieszkaniec>");
            ...
            out.println("<input type=submit value=\"Zmień hasło\"/><br>");
