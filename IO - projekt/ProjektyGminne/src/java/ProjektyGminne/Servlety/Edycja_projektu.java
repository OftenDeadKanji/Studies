        ...
        if (zalogowany == 'u') {
            ...
            try (PrintWriter out = response.getWriter()) {
                ...
                try {
                    ...
                    projekt = (Projekty) em.createNamedQuery("Projekty.findByIdP").setParameter("idP", IDP).getSingleResult();
                ...
                String data_glosowania = projekt.getDataGłosowania();
                ...
                for (Załączniki z : zalaczniki) {
                    if (z.getIdP() == projekt) {
                        ...
                        long IDZ = z.getIdZ(); // Id załącznika 
