 ...
 * @author Frogi
 */
@WebServlet(name = "zmien_tytul", urlPatterns = {"/zmien_tytul"})
public class zmien_tytul extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (zalogowany == 'u') {
            try (PrintWriter out = response.getWriter()) {
                ...
                String nowy_tytul_projektu = request.getParameter("nowy_tytul_projektu");

                if (nowy_tytul_projektu.length() == 0) {
                    out.println("<h2 style=\"color: #BB1245;\">");
