        ...
        if (zalogowany == 'u') {
            try (PrintWriter out = response.getWriter()) {
                ...
                if (nazwa_zalacznika.length() == 0 || link_zalacznika.length() == 0) {
                    ...
                    try {
                        // dodanie nowego załącznika do BD
                        ...
                        nowyZalacznik.setZałącznik(nazwa_zalacznika, link_zalacznika, projekt);
