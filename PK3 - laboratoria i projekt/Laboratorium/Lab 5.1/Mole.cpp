...
Mole::Mole(std::string name, int age, bool isMale, WORD color) : AnimalSprite(name, age, isMale, color)
{}

Mole::Mole(const Mole &Mole) : AnimalSprite(Mole)
{}

Mole::Mole(Mole &&Mole) : AnimalSprite(move(Mole))
{}
...
AnimalSprite::Action Mole::ActionInfo(int index)
{
...
{
	return "Mole " + AnimalSprite::DoGetInfo();
}
#pragma endregion

void Mole::SeeOtherAnimal(AnimalSprite &animal)
{
