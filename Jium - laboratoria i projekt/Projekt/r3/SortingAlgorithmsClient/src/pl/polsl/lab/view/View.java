...
public abstract class View {
    ...
    /**
     * A methode that shows a message box.
    ...
    /**
     * A method that informs if view's frame is closed or not.
     * @return true if frame is closed, false otherwis
     */
    public boolean getIsFrameClosed(){
        return frame.getIsClosed();
    }
    
    /**
     * A methode that writes an error message to a file.
     * @param message A message to be writter to a file.
     * @throws FileNotFoundException - can be thrown if a file can't be found.
     */
