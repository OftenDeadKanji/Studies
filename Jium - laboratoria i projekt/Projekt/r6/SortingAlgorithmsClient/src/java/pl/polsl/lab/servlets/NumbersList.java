...
/**
 * A servlet class that shows Numbers in DB to a user.
 *
...
public class NumbersList extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                List<Numbers> numbs = getAllNumbers();

                request.getSession().setAttribute("numbersList", numbs);
                request.setAttribute("numbersList", numbs);
                ...
                out.println("<table id=\"table\" border=\"3\">\n"
                        ...
                        + "    <th id=\"IndexColumn\">Index</th>\n"
                        + "    <th id=\"IsPointedAtColumn\">Is pointed at</th>\n"
                        + "</tr>");
                ...
                for (int i = 0; i < numbs.size(); i++) {
                    ...
                    out.println(numbs.get(i).getId());
                    out.println("</td>");

                    out.println("<td id=\"ValueColumn\">");
                    out.println(numbs.get(i).getValue());
                    out.println("</td>");

                    out.println("<td id=\"TableIDColumn\">");
                    out.println(numbs.get(i).getTableId().getId());
                    out.println("</td>");

                    out.println("<td id=\"IndexColumn\">");
                    out.println(numbs.get(i).getIndex());
                    out.println("</td>");

                    out.println("<td id=\"IsPointedAtColumn\">");
                    out.println(numbs.get(i).isIsPointedAt());
                    out.println("</td>");
    ...
    private java.util.List<pl.polsl.lab.services.Numbers> getAllNumbers() {
