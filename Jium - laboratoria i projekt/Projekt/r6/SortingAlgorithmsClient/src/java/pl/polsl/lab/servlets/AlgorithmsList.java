...
public class AlgorithmsList extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                List<Algorithms> algs = getAllAlgorithms();
                ...
                for (int i = 0; i < algs.size(); i++) {
                    ...
                    out.println(algs.get(i).getTableId().getId());
                    out.println("</td>");

                    out.println("<td id=\"StateColumn\">");
                    out.println(algs.get(i).getState());
                    out.println("</td>");
    ...
    private java.util.List<pl.polsl.lab.services.Algorithms> getAllAlgorithms() {
