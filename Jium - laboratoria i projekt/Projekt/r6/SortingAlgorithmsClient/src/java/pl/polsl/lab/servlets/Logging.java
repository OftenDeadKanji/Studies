...
public class Logging extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</p>");
            out.println("<p id = \"p2\">");
            out.println("(test account: admin admin)");
            out.println("</p>");

            out.println("<form action=\"LoggingCheck\">");
            out.println("<p id=\"fields\">Login: <input type=text name=login></p>");
            out.println("<p id=\"fields\">Password: <input type=password name=password></p>");
            out.println("<input id=\"button\" type=submit value=\"Log in\">");
            out.println("</form>");
