    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                List<Numbers> numbs = em.createQuery("SELECT numb FROM Numbers numb").getResultList();
                ...
                for (int i = 0; i < numbs.size(); i++) {
                    ...
                    out.println(numbs.get(i).getTable().getId());
                    out.println("</td>");
                    ...
                    out.println(numbs.get(i).getIsPointedAt());
                    out.println("</td>");
